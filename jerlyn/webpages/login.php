...
<body>
    ...
    <div class="container">
        <div class="signup-container" id="login-container">
            <form class="signup-form" action="../PHPScript/login.php" method="post">
                <h2>Log In</h2>
                ...
                <button type="submit" href="../webpages/home.php">Log In</button>
            </form>
        </div>
    </div>
        <div class="signup">
            <form>
            <a href="../webpages/signup.php">Sign Up</a>
        </div>
    <footer>
